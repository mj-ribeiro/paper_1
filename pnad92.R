...
# minimo 1992 = Cr$ --> (522186.94/1000)/2750


Cr = (522186.94/1000)/2750  # wage set/92

defla = inpc[inpc$ano==1992, 'd10']
...
pnad92 <- read_dta("D:/PNADs/PNAD_DATAZOOM/pnad1992pes.dta")
...
alfa92 = pibs[pibs$Data==1992, 1:sec+1]/pibs[pibs$Data==1992, sec+2 ]



library(data.table)

alfa92 = transpose(alfa92)
colnames(alfa92) = c('alfa92')
...
df = data.frame(W_i, p_i, anos_est, phi, alfa92)
...
write.xlsx(df, file='data_92.xlsx')
